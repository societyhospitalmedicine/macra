...
<head>
    ...
    <meta name="description" content="Help increase awareness about antibiotic resistance through the Society of Hospital Medicine’s “Fight the Resistance” campaign information, resources and posters.">
    <meta name="key-words" content="Antibiotic Resistance,Antibiotic Resistance Bacteria,fight the resistance, 
    antibiotic-resistant infections, 
    antibiotic-resistant infection,antibiotic prescribing behaviors,
    antibiotic prescribing problem">
    
    <meta name="author" content="">

    <title>Antibiotic Resistance | Fight the Resistance | Society of Hospital Medicine</title>
    <!-- Bootstrap Core CSS -->
                      ...
                      <div class="tab-content">
                        ...
                        <div style="min-height: 315px;" role="tabpanel" class="tab-pane fade" id="tabs-tab2">
                            ...
                            <p>SHM expects that, at the very least, the performance year for the MIPS will begin in 2017. This follows the 2-year lag in the Reporting Year-Performance Year 
                              cycle previously developed in PQRS and the physician value modifier. So with adjustments to payments beginning in 2019, it is critical to understand the available 
                              and feasible options for you and your group and participate in 2017 to avoid penalties.
                            </p>
                        </div>
...
<!-- TODO 
 * get embeded tracking code links from kim
 * uncomment additional resources section and nav li once link content comes in 
